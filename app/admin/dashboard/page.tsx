  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        ...
        <div className="rounded-lg border p-4">
          <div className="text-xs font-medium text-muted-foreground">Fundis</div>
      ...
      <section className="rounded-lg border p-4">
        ...
        <div className="mt-3 text-sm text-muted-foreground">View audit logs in the admin API.</div>
      </section>
    </div>
  )
}
