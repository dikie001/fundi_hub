      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card className="border-border bg-card/60">
          <CardHeader className="pb-2">
            <CardTitle className="flex items-center gap-1.5 text-xs font-bold tracking-wider text-muted-foreground uppercase">
              <Wrench className="h-3.5 w-3.5 text-primary" /> Matched Fundis
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="border-border bg-card/60">
          <CardHeader className="pb-2">
            <CardTitle className="flex items-center gap-1.5 text-xs font-bold tracking-wider text-muted-foreground uppercase">
              <MapPin className="h-3.5 w-3.5 text-primary" /> Project Area
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="border-border bg-card/60">
          ...
          <CardContent>
            <div className="text-sm leading-snug font-extrabold text-foreground">
              {profile?.budgetRange || "—"}
            </div>
            <p className="mt-1 text-[11px] text-muted-foreground">
              Your target budget
        ...
        <Card className="border-border bg-card/60">
          <CardHeader className="pb-2">
            <CardTitle className="flex items-center gap-1.5 text-xs font-bold tracking-wider text-muted-foreground uppercase">
              <TrendingUp className="h-3.5 w-3.5 text-primary" /> Profile Score
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-extrabold text-foreground">
