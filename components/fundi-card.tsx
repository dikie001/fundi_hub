          ...
          <div className="flex-grow">
            <div className="flex items-start justify-between gap-2">
              ...
              {fundi.premiumLevel === "top" && (
                <Badge className="flex gap-1 bg-amber-600 whitespace-nowrap hover:bg-amber-700">
                  <Star size={12} />
                  Top Verified
                </Badge>
              )}
              {fundi.premiumLevel === "verified" && (
                <Badge className="flex gap-1 bg-blue-600 whitespace-nowrap hover:bg-blue-700">
                  <Shield size={12} />
                  Verified
                </Badge>
              )}
